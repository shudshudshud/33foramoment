...
// Update the verifyFriendPassword function in lib/clientData.js
...
export function verifyFriendPassword(inputPassword, friendId) {
  ...
  // If friend not found, authentication fails
  if (!friend) return false;
  
  // For development testing - log the values (remove in production)
  console.log('Checking password for:', friendId);
  console.log('Input password:', inputPassword);
  console.log('Stored password:', friend.password);
